...
# 47 "rw.c" 3 4
   stderr
# 47 "rw.c"
   , "\033[1m\033[33m" "[PID %05d] " "\033[0m" "\x1b[31m" "ERR [LINE %05d] " "\033[0m", getpid(), 47); fprintf(
# 47 "rw.c" 3 4
   stderr
# 47 "rw.c"
   , "Child has died, terminating"); fprintf(
# 47 "rw.c" 3 4
   stderr
# 47 "rw.c"
   , "\nERRNO: %s\n", strerror(
...
# 61 "rw.c" 3 4
   stderr
# 61 "rw.c"
   , "\033[1m\033[33m" "[PID %05d] " "\033[0m" "\x1b[31m" "ERR [LINE %05d] " "\033[0m", getpid(), 61); fprintf(
# 61 "rw.c" 3 4
   stderr
# 61 "rw.c"
   , "Parent has died, terminating"); fprintf(
# 61 "rw.c" 3 4
   stderr
# 61 "rw.c"
   , "\nERRNO: %s\n", strerror(
...
# 66 "rw.c" 3 4
   stderr
# 66 "rw.c"
   , "\033[1m\033[33m" "[PID %05d] " "\033[0m" "\x1b[31m" "ERR [LINE %05d] " "\033[0m", getpid(), 66); fprintf(
# 66 "rw.c" 3 4
   stderr
# 66 "rw.c"
   , "Code line:" "fd = open(filename, O_RDONLY)"); fprintf(
# 66 "rw.c" 3 4
   stderr
# 66 "rw.c"
   , "\nERRNO: %s\n", strerror(
...
# 123 "rw.c" 3 4
       stderr
# 123 "rw.c"
       , "\033[1m\033[33m" "[PID %05d] " "\033[0m" "\x1b[31m" "ERR [LINE %05d] " "\033[0m", getpid(), 123); fprintf(
# 123 "rw.c" 3 4
       stderr
# 123 "rw.c"
       , "Usage: %s [filename]", *argv); fprintf(
# 123 "rw.c" 3 4
       stderr
# 123 "rw.c"
       , "\nERRNO: %s\n", strerror(
...
# 128 "rw.c" 3 4
           stderr
# 128 "rw.c"
           , "\033[1m\033[33m" "[PID %05d] " "\033[0m" "\x1b[31m" "ERR [LINE %05d] " "\033[0m", getpid(), 128); fprintf(
# 128 "rw.c" 3 4
           stderr
# 128 "rw.c"
           , "fork()"); fprintf(
